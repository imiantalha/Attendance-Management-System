...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Record an employee's check-in and check-out details.</p>
    </div>
        ...
        <form action="{{ route('attendances.store') }}" method="POST" novalidate>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input id="attendance_date" type="date" name="attendance_date" value="{{ old('attendance_date', now()->toDateString()) }}" class="form-control @error('attendance_date') is-invalid @enderror" required>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input id="start_time" type="time" name="start_time" value="{{ old('start_time') }}" class="form-control @error('start_time') is-invalid @enderror" required>
                    @error('start_time')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input id="end_time" type="time" name="end_time" value="{{ old('end_time') }}" class="form-control @error('end_time') is-invalid @enderror">
